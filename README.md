...
- 根据属性值出现次数进行排序，选取前200的属性作为侯选属性
- 将这些侯选属性进行归类，将相同的属性值归为一类
...
与之的抽取规则一样，只展示出人物关系即可

简单的抽取方式：只显示人物链接页面的实体
...
- 构建所有wiki页面的节点，其节点类型设置为空
- 根据name属性对页面进行修改，设施为人物，并根据infobox扩展其属性
- 根据infobox扩展其关系
